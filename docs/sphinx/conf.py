...
autoapi_dirs = ["../../src/algokit_subscriber"]
autoapi_options = [
    "members",
    "undoc-members",
    "show-inheritance",
...
# Hide the v1 implementation modules so autoapi documents only the public
# surface re-exported from algokit_subscriber/__init__.py (the package index
# plus the public types in types/{arc28,event_emitter,subscription}.py).
autoapi_ignore = [
    "*algokit_subscriber/block.py",
    "*algokit_subscriber/indexer_lookup.py",
    "*algokit_subscriber/subscriber.py",
    "*algokit_subscriber/subscription.py",
    "*algokit_subscriber/transform.py",
    "*algokit_subscriber/utils.py",
    "*algokit_subscriber/types/block.py",
    "*algokit_subscriber/types/indexer.py",
    "*algokit_subscriber/types/transaction.py",
]
