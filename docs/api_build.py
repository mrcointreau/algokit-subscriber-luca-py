...
def _flatten_autoapi() -> None:
    """Flatten autoapi/ -- move algokit_subscriber/ up one level so Starlight sees api/algokit_subscriber/."""
...
def _shorten_qualified_names() -> None:
    ...
    headings show short names (e.g. "AccountManager" not "algokit_subscriber.x.y.AccountManager").
    Handles: algokit_subscriber.*, algokit_transact.*, algokit_common.*, typing_extensions.*, collections.abc.*
