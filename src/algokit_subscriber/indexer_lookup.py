    ...
    def build_request(next_token: str | None = None) -> dict[str, Any]:
        args: dict[str, Any] = {
            ...
            "currency-greater-than": (
                options["currency-greater-than"] if options and "currency-greater-than" in options else None
            ),
            "currency-less-than": (
                options["currency-less-than"] if options and "currency-less-than" in options else None
            ),
        }
